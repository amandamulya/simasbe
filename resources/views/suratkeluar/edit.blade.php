...
<div class="card-body">
<form action="{{ route('suratkeluars.update', $suratkeluar->id) }}"
...
Surat" value="{{$suratkeluar->no_surat}}"> 
...
Tgl. Surat" value="{{$suratkeluar->tgl_surat}}"> 
...
Tgl. Keluar" value="{{$suratkeluar->tgl_keluar}}"> 
...
Tujuan Surat" value="{{$suratkeluar->tujuan}}"> 
...
rows="5">{{$suratkeluar->ringkasan}}</textarea>
...
<a href="{{url('suratkeluarfile/'.$suratkeluar->file_surat)}}"
    ...
    <div class="my-2">
     ...
     <a href="{{route('suratkeluars.index')}}" class="btn btn-danger"><i
