...
<div class="px-4 py-5">
 ...
 <a href="{{url('suratmasukpdf')}}" class="btn btn-danger"><i
class="fa-solid fa-file-pdf"></i> Export PDF</a>
 ...
 <td>{{$row->ringkasan}}</td>
 <td>
 <form action="{{route('suratmasuks.destroy',$row->id)}}"
method="post">
 <a class="mx-1 btn btn-success btn-sm"
href="{{route('suratmasuks.show', $row->id)}}">
 <i class="fa fa-eye"></i>
 </a>&nbsp;
<a class="mx-1 btn btn-warning btn-sm"
href="{{route('suratmasuks.edit', $row->id)}}">
